# AIエラー時のメッセージ
AI_ERROR_MESSAGE = "AIの応答でエラーが発生しました"
# ==========================================
# RAG・ベクターストア関連のパラメータ
# ==========================================
RAG_RETRIEVER_TOP_K = 10  # ベクターストアから取得する関連ドキュメント数（精度向上のため増加）
RAG_CHUNK_SIZE = 500     # チャンク分割時のチャンクサイズ（精度向上のため増加）
...
【条件】
1. ユーザー入力内容と以下の文脈、文書タイトル、ファイル名との間に関連性がある場合、必ず文脈に基づいて日本語で分かりやすく回答してください。
